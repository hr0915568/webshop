...
create table user (
  ...
  due_date                      datetime(6),
  constraint uq_user_order_model_id unique (order_model_id),
...
alter table user add constraint fk_user_order_model_id foreign key (order_model_id) references order_model (id) on delete restrict on update restrict;
...
alter table user drop foreign key fk_user_order_model_id;
